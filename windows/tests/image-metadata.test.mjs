...
const featured = await fs.readFile(path.join(windowsRoot, "assets", "candy-background.png"));
...
const cli = spawnSync(process.execPath, [helper, "--check", path.join(windowsRoot, "assets", "candy-background.png")], {
  encoding: "utf8",
});
