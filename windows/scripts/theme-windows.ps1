...
function Initialize-DreamSkinThemeStore {
  ...
  # Seed the exact image declared by the bundled theme instead of assuming the
  # upstream wallpaper filename. Custom editions can safely ship a PNG avatar,
  # JPG wallpaper, or another validated image without breaking installation.
  ...
  $presetDirectory = Join-Path $paths.Saved 'preset-codex-candy-jelly'
